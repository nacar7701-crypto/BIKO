...
import HistoryScreen from './src/views/HistoryScreen'; // Se mantiene la importación de HistoryScreen
...
    {/* En el AuthStack solo tiene sentido tener el login/registro. Moveremos Account/Report al AppStack */}
  </Stack.Navigator>
);

// --- Stack para usuario logueado (MapScreen y futuras pantallas) ---
// **IMPORTANTE:** Agregamos todas las pantallas del AppStack aquí.
const AppStack = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    <Stack.Screen name="MapScreen" component={MapScreen} />
    <Stack.Screen name="Account" component={AccountScreen} /> 
    <Stack.Screen name="Report" component={ReportScreen} /> 
    <Stack.Screen name="History" component={HistoryScreen} /> {/* Se añade History */}
  </Stack.Navigator>
);
